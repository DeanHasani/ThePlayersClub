        ...
        <div className="flex h-12 items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="sm:hidden flex items-center space-x-0.5">
              <Button
                variant="ghost"
                className="flex items-center space-x-1 text-xs font-medium tracking-wider hover:bg-transparent px-2"
                onClick={toggleShop}
              >
                <span>SHOP</span>
              ...
              <Button
                variant="ghost"
                className="flex items-center space-x-1 text-xs font-medium tracking-wider hover:bg-transparent px-1"
                onClick={toggleInfo}
              >
                <span>INFO</span>
            ...
            <div className="hidden sm:flex items-center space-x-1">
              <Button
                variant="ghost"
                className="flex items-center space-x-1 text-xs font-medium tracking-wider hover:bg-transparent"
                onClick={toggleShop}
              >
                <span>SHOP</span>
                <ChevronDown className={`h-3 w-3 transition-transform ${shopOpen ? "rotate-180" : ""}`} />
          ...
          <div className="flex items-center space-x-1 sm:space-x-3">
            ...
            <Button
              ...
              className="text-xs font-medium tracking-wider hover:bg-transparent px-2 sm:px-3"
            >
            ...
            <Button
              variant="ghost"
              onClick={toggleCart}
              className="relative text-xs font-medium tracking-wider hover:bg-transparent px-2 sm:px-3"
            >
              {/* Desktop version */}
          ...
          <div className="border-t border-gray-200 py-4">
            <form onSubmit={handleSearch} className="flex items-center space-x-2">
              ...
              <input
                ...
                className="flex-1 border-none outline-none text-sm font-medium"
                autoFocus
              />
              {searchQuery && (
